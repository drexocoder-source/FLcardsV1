...
def back_keyboard(label: str = "Club hub", callback_data: str = "menu:home") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup([[InlineKeyboardButton(label, callback_data=callback_data, style=ButtonStyle.PRIMARY)]])
...
def info_keyboard(destination: str = "menu:home") -> InlineKeyboardMarkup:
    return InlineKeyboardMarkup(
        [[InlineKeyboardButton("Club hub", callback_data=destination, style=ButtonStyle.PRIMARY)]]
    )
